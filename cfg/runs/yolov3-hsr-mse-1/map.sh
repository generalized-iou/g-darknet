...
pushd $RUN_PATH
python scripts/voc_all_map.py --data_file cfg/runs/yolov3-hsr-mse-1/data --cfg_file cfg/runs/yolov3-hsr-mse-1/cfg --weights_folder backup/yolov3-hsr-mse-1/ --lib_folder lib
popd
