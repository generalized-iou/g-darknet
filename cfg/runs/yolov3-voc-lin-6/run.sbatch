...
#SBATCH --job-name="yolov3-voc-lin-6"
#SBATCH --output=batch/out/yolov3-voc-lin-6.out
...
#LD_LIBRARY_PATH=lib ./darknet detector train cfg/runs/yolov3-voc-lin-6/data cfg/runs/yolov3-voc-lin-6/cfg datasets/voc/darknet53.conv.74
