...
pushd $RUN_PATH
python scripts/voc_all_map.py --data_file cfg/runs/yolov3-voc-lin-3/data --cfg_file cfg/runs/yolov3-voc-lin-3/cfg --weights_folder backup/yolov3-voc-lin-3/ --lib_folder lib
popd
