...
pushd $RUN_PATH
python scripts/voc_all_map.py --data_file cfg/runs/yolov3-voc-lin-4/data --cfg_file cfg/runs/yolov3-voc-lin-4/cfg --weights_folder backup/yolov3-voc-lin-4/ --lib_folder lib
popd
